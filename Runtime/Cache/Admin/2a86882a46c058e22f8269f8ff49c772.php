...
<head>
    <meta charset="UTF-8">
    <title>『豪情』后台管理</title>
    <link rel="stylesheet" type="text/css" href="<?php echo (AD_CSS); ?>/common.css"/>
    <link rel="stylesheet" type="text/css" href="<?php echo (AD_CSS); ?>/main.css"/>
    <script type="text/javascript" src="<?php echo (AD_JS); ?>/libs/modernizr.min.js"></script>
</head>
<body>
